...
<head>
	<meta charset="UTF-8">
	<title>Hasan's API</title>
	<meta name="title" content="Hasan's API">
	<meta name="description" content="My APIs">
...
<body>
	...
	<header>
		...
		<div class="heroe">
			<h1>Welcome to Hasan's API</h1>
			<h2>The small API website</h2>
		</div>
	...
	<section>
		<div class="menu">
			<h1>What would you try?</h1>
			<ul style="text-align: left;">
				<li class="menu-item hidden"><a href="/api/">API</a></li>
				<li class="menu-item hidden"><a href="/cdn/">CDN</a></li>
			</ul>
		</div>
	</section>
	...
	<div class="further">
		<section>
			...
			<p>You can explore all my libraries and modules on <a href="/cdn/">CDN</a></p>
			<!-- <h2>
				<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
	...
	<footer>
		<div class="environment">
			...
			<p>Powered by <a href="https://codeigniter.com/" style="color: rgb(173,216,230);">CodeIgniter 4</a></p>
		</div>
